...
import {  View,KeyboardAvoidingView,Text,Modal,Alert,Image} from 'react-native';
  ...
  >
      <View  style={styles.wrap}>
        ...
        <View>
          ...
          <MainButton onPress={() => { props.navigation.navigate("ListPets")}}><ButtonText >Próximo</ButtonText></MainButton>

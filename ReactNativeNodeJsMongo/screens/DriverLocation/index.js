...
const DriverLocation = (props) => {
  ...
  const getCurrentPosition = async () => {
    ...
    setRegion({ latitude:latitude, longitude:longitude,  latitudeDelta: 0.01,
      longitudeDelta: 0.01 });
    console.log(region)
  };
      ...
      <View style={styles.root}>
        <View style={styles.wrap}>
          ...
          {region &&
            ...
            <Marker coordinate = {{latitude:Number(initialRegion.latitude)-0.004,longitude: Number(initialRegion.longitude)-0.003}}
